...
public class MongoDBStorer {
	...
	private static void storeDealerships() throws IOException, JsonParseException, JsonMappingException {
	...
	private static void storeMakes() throws IOException, JsonParseException, JsonMappingException {
	...
	private static void storeCars() throws IOException, JsonParseException, JsonMappingException {
