	...
	<!--end of NEW Navigation bar-->
	  ...
	  <ul class="offset-2 make-grid" id="make-grid">
		  ...
		  for(String s:pageMakes){
			  ...
			  String listing= "<li class='card np-element np-hover col-4 make-card' style='margin: 20px;height:300px;' >"+
			...
			if(!image.equals(""))
				listing += "<div class='np-img-wrapper' width='35px' height='35px'>" + "<img class='np-img-expand' src='" + image + "' width='inherit' height='inherit' style='margin: 10px'></div>";
			if(!numCars.equals(""))
