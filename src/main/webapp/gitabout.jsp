...
<html lang="en">
  ...
  <body>
	...
	<!--Navigation bar-->
	<iframe src="/html/navbar.html" frameborder="0" style="width:100%;z-index: 0;"></iframe>
       ...
       <div class="row">
          ...
          <div class="col-md-4">
             <div class="np-element np-hover np-shadow-double">
			   ...
			   <p class="card-text">Year: Junior<br>Post-Grad: Become a QA Developer<br>
			     Drives: 2018 Toyoto Corolla<br>"I know nothing about cars..."</p>
                </div>
				</div>
          </div>
       </div>
